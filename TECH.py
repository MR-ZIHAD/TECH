...
\x1b[1;96m##           ##     ##     #######
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94m➣  Facebook : MD ZAHIDUL ISLAM
\x1b[1;94m➣  Note     : Dont ReEdit It 
\x1b[1;94m➣  Whatsapp  : +8801842827520
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;97mAccess Granted "#Dev:MR:ZIHAD
	    time.sleep(1)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		jalan(' \033[1;97m   ✧ \033[1;97m👉 : \033[1;97mMR-ZIHAD HARD PROGRAMMER IN BANGLADESH' ) 
